...
/**
 * Servlet implementation class ServletOrdinazioni
 */
@WebServlet("/ServletOrdinazioni")
public class ServletOrdinazioni extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletOrdinazioni() {
        super();
